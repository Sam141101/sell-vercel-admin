...
export default function Canceled({ admin, dispatch, axiosJWT, BASE_URL_API }) {
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                return (
                    <>
                        <Link to={`/order/canceled/${params.row._id}`}>
        ...
        const getOrders = async () => {
            try {
                const res = await axiosJWT.get(
                    BASE_URL_API + 'orders/list-status-order/cancel/',
                    {
                        headers: { token: `Bearer ${token}` },
                    },
                );
